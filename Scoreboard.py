...
J.place(x = 230, y = 140)
player1_entry = Entry(root, textvariable = player1, width = "10")
player1_entry.place(x = 80, y = 50)
player2_entry = Entry(root, textvariable = player2, width = "10")
player2_entry.place(x = 80, y = 90)
ends2_entry = Entry(root, textvariable = ends2, width = "10")
ends2_entry.place(x = 210, y = 50)
